#pragma checksum "C:\Users\sebas\Desktop\Entrance Folder\University\UK Electronic Democracy\UK Electronic Democracy\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "336723a4d91d0a0e6c24b2f391703c10bfa1bf9f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"336723a4d91d0a0e6c24b2f391703c10bfa1bf9f", @"/Pages/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n<!DOCTYPE html>\r\n<html lang=\"en\">\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336723a4d91d0a0e6c24b2f391703c10bfa1bf9f4043", async() => {
                WriteLiteral(@"
...
");
                WriteLiteral(@"            else if (clicked_id == ""login"") {
          ...
          ");
                WriteLiteral(@"      loggingInOrRegistering = 1;
        ...
        function loginOrReg(clicked_id) {
           ...
           ");
                WriteLiteral(@" if (clicked_id == ""login"") {
 ...
 ");
                WriteLiteral(@"       //Takes user input and filters a table for associated information
        ...
        function citizenCandidateorParty(cl");
                WriteLiteral(@"icked_id) {
            if (loggingInOrRegistering == 0) {
                ...
                if (clicked_id == ""citizenLogOrReg"") {
                    accountTypeChoice = ""citizen"";
                    document.getElementById(""upperBodyTextLog"").innerHTML = ""Regi");
                WriteLiteral(@"stering as: Citizen"";
                }
                else if (clicked_id == ""partyLogOrReg"") {
                    accountTypeChoice = ""party"";
        ...
        function saveDetails() {
            ...
            //checks if password inputs exist in bot");
                WriteLiteral(@"h slots
            if ((password != """" && passwordConfirm != """") || (password != """" || passwordConfirm != """")) { //doesn't work perfectly
                ...
                if (password == passwordConfirm) {
                    ...
                    if (accountTypeChoice == ""citizen"") {
                        ...
                        document.getEl");
                WriteLiteral(@"ementById(""defunctCredentialsReg"").innerHTML = ""DEBUG: could not instantiate single class"";
                        ...
                        document.getElementById(""defunctCredentialsRe");
                WriteLiteral(@"g"").innerHTML = ""DEBUG: could not enter class"";
                ...
                //password inputs did not match
                    ...
                    document.getElementById(""defunctCredentialsReg"").innerHTML = ""Password and password confirmat");
                WriteLiteral(@"ion do not match."";
                }
            }
            else {
        ...
        class CitizenAccount extends Account {
            ...
            collectDetails() {
                ...
                this.NIN = document.getElementById(""nationalIns");
                WriteLiteral(@"uranceNumberReg"").value;
                ...
                if (this.firstName != """" && this.email != """" && this.NIN != """" && this.nationalities != """" && this.resAddress != """" && this.birthday != """" && this.password != null && this.passwordConfirm != null) {
                    document.getElementById(""defunctCredentialsReg"").inner");
                WriteLiteral(@"HTML = ""Credentials inputted successfully"";
                }
                else {
        ...
        class OldCitizenAccount extends Account {
            ...
            collectDetails() {
                ...
                this.firstName = document.getElementById(""firstNameReg"").value;
                this.e");
                WriteLiteral(@"mail = document.getElementById(""emailReg"").value;
            ...
            allDetailsFilled() {
                //assign values then:
                if (this.firstName != null && this.email != null && this.NIN != null && this.nationalities != null && this.resAddress != null && this.birthday != null && super.password != null && super.passw");
                WriteLiteral(@"ordConfirm != null) {
                    //success
                }
                else {
                    document.getElementById(""defunctCredentialsReg"").innerHTML = ""Missing required information."";
        ...
        class OldAdminAccount extends Account {
            constructor(firstNa");
                WriteLiteral(@"me, email, NIN, nationalities, resAddress, birthday) {
...
<style>
   ...
   ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336723a4d91d0a0e6c24b2f391703c10bfa1bf9f27507", async() => {
                WriteLiteral(@"
    ...
    ");
        ...
        <div class=""row"" id=""logRegBody1"">
            ...
            ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336723a4d91d0a0e6c24b2f391703c10bfa1bf9f35344", async() => {
                    WriteLiteral(@"
                <div id=""loginDisplay"">
                    <!--<h3 id=""upperBodyTextLog"" class=""text-left"">Logging in as: Citizen</h3>
            <div class=""row"">
                ...
                <div id=""registerDisplay"">
                    ...
                    <div class=""row"">
                        ...
                        <div class=""col-sm-2"">
                            <button type=""button"" id=""partyReg"" class=""btn-sm"" onclick=""citizenCandidateorParty(this.id)""><h2 class=""text-center""");
                    WriteLiteral(@">Party</h2></button>
                        </div>
                        <div class=""col-sm-2"">
                    ...
                    <div class=""row"">
                        ...
                        <div class=""col-sm-6"">
                            <label>Confirm Password:</label>
                            <input t");
                    WriteLiteral(@"ype=""password"" class=""form-control"" id=""confirmPasswordReg"" />
                    ...
                    <div class=""row"">
                        <div class=""col-sm-6"">
                            ...
                            <button type=""button"" class=""btn-sm""><h2 id=""submitRegDetails"" class=""text-center"" onclick=""saveDetails(this.id)""");
                    WriteLiteral(">Submit</h2></button>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            ");
                }
                );
